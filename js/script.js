        ...
        if (servicesData[servicioId]) {
            ...
            for (const [subId, sub] of Object.entries(servicio.subservicios)) {
                ...
                sub.empresas.forEach((empresa, index) => {
                    const uniqueId = `${subId}-${index}`;
                    mainHTML += `
                        <div class="empresa-card" id="card-${uniqueId}">
            ...
            cards.forEach(card => {
                card.addEventListener('click', function(e) {
                    // Evitar que los botones dentro activen el toggle
            ...
            servicioMain.innerHTML = `<p style="text-align:center;padding:3rem;">Servicio no encontrado. <a href="index.html">Volver al inicio</a>.</p>`;
        }
    }
});
